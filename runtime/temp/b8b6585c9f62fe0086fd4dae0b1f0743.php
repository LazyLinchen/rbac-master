<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\WWW\blogNote\public/../application/admin\view\access\nodeadd.html";i:1492681230;s:67:"E:\WWW\blogNote\public/../application/admin\view\Common\header.html";i:1493112829;s:65:"E:\WWW\blogNote\public/../application/admin\view\Common\left.html";i:1492681434;s:67:"E:\WWW\blogNote\public/../application/admin\view\Common\footer.html";i:1492764109;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
        ...
        <div class="panel-boby panel-height">
            <form class="form form-horizontal builder-form" action="__SELF__" method="post">
              <div class="form-group">
                <label class="col-sm-2 control-label">节点标题</label>
                <div class="col-sm-10">
                  <input type="text" name="title" class="form-control form-text" placeholder="例如:系统后台" value="<?php echo $info['title']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">节点名称</label>
                <div class="col-sm-10">
                  <input type="text" name="name" class="form-control form-text" placeholder="例如：Admin" value="<?php echo $info['name']; ?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select class="form-control form-text" name="level">
                    <?php echo $node['levelOpiton']; ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
