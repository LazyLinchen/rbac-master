<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"E:\WWW\blogNote\public/../application/admin\view\user\articleclassifty.html";i:1493281367;s:67:"E:\WWW\blogNote\public/../application/admin\view\Common\header.html";i:1493441951;s:65:"E:\WWW\blogNote\public/../application/admin\view\Common\left.html";i:1492681434;s:67:"E:\WWW\blogNote\public/../application/admin\view\Common\footer.html";i:1493438330;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <form class="form-inline col-lg-5 col-md-5 col-sm-5" action="__SELF__" method="get">
              <div class="form-group">
                <input type="text" name="keyword" class="form-control" placeholder="文章分类名称" value="<?php echo $keyword; ?>">
              </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 pull-right text-center">
              ...
              <a class="btn btn-primary active" href="<?php echo url('addArticleClassifty'); ?>" role="button">添加文章分类</a>

              <!-- Contextual button for informational alert messages -->
              <a class="btn btn-info active js-Allstop" link="<?php echo url('changeStatus', array('model'=>'ArticleClassifty')); ?>" href="javascript:void(0);" role="button">隐藏</a>

              <!-- Indicates caution should be taken with this action -->
              <a class="btn btn-warning active js-Allstart" link="<?php echo url('changeStatus', array('model'=>'ArticleClassifty')); ?>" href="javascript:void(0);" role="button">显示</a>

              <!-- Indicates a dangerous or potentially negative action -->
              <a class="btn btn-danger active js-Alldel" link="<?php echo url('changeStatus', array('model'=>'ArticleClassifty')); ?>" href="javascript:void(0);" role="button">删除</a>
            ...
            <tbody>
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                    <tr>
                        ...
                        <td><?php if($vo[status] == '1'): ?>显示<?php endif; if($vo[status] == '0'): ?>隐藏<?php endif; ?></td>
                        <td>
                          <a title="编辑" class="label label-primary" href="<?php echo url('User/addArticleClassifty', array('id' => $vo['id'])); ?>">编辑</a>
                          <?php if($vo[status] == '0'): ?><a class="label label-info js-start" link="<?php echo url('changeStatus', array('id' => $vo['id'], 'model'=>'ArticleClassifty')); ?>" href="javascript:void(0);">显示</a>&nbsp;<?php endif; if($vo[status] == '1'): ?><a class="label label-warning js-stop" link="<?php echo url('changeStatus', array('id' => $vo['id'], 'model'=>'ArticleClassifty')); ?>" href="javascript:void(0);">隐藏</a>&nbsp;<?php endif; if($vo[status] != '10'): ?><a class="label label-danger js-del" link="<?php echo url('changeStatus', array('id' => $vo['id'], 'model'=>'ArticleClassifty')); ?>" href="javascript:void(0);">删除</a>&nbsp;<?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
