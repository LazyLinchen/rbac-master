<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"E:\WWW\blogNote\public/../application/admin\view\access\rolelist.html";i:1493433032;s:67:"E:\WWW\blogNote\public/../application/admin\view\Common\header.html";i:1493112829;s:65:"E:\WWW\blogNote\public/../application/admin\view\Common\left.html";i:1492681434;s:67:"E:\WWW\blogNote\public/../application/admin\view\Common\footer.html";i:1493438330;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <!-- <form class="form-inline col-lg-5 col-md-5 col-sm-5" action="__SELF__" method="get">
              <div class="form-group">
                <input type="text" name="keyword" class="form-control" placeholder="显示名称" value="<?php echo $keyword; ?>">
              </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 pull-right text-center">
              ...
              <a class="btn btn-primary active" href="<?php echo url('roleAdd'); ?>" role="button">添加</a>

              <!-- Contextual button for informational alert messages -->
              <a class="btn btn-info active js-Allstop" link="<?php echo url('changeStatus', array('model'=>'role')); ?>" href="javascript:void(0);" role="button">禁用</a>

              <!-- Indicates caution should be taken with this action -->
              <a class="btn btn-warning active js-Allstart" link="<?php echo url('changeStatus', array('model'=>'role')); ?>" href="javascript:void(0);" role="button">启用</a>

              <!-- Indicates a dangerous or potentially negative action -->
              <a class="btn btn-danger active js-Alldel" link="<?php echo url('changeStatus', array('model'=>'role')); ?>" href="javascript:void(0);" role="button">删除</a>
